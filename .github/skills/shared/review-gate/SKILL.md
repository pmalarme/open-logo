...
renumbered `spec/grammar.md` under existing citations. Every citation names a section anchor, never
a line number ([`shared/spec-fidelity`](../spec-fidelity/SKILL.md)).
