 ...
 * (`spec/execution-model.md:753-754`, e.g. `5` and `"5"` name the same slot, `5` and `"05"` do
 ...
 * values **compare by identity, not by position or shape** (`spec/execution-model.md:803` — the
...
export class OLTurtle {
   ...
   * (`spec/execution-model.md:803`) — two turtle values are the same turtle exactly when their ids
