 ...
 * (`spec/execution-model.md:850-851`, e.g. `5` and `"5"` name the same slot, `5` and `"05"` do
 ...
 * values **compare by identity, not by position or shape** (`spec/execution-model.md:900` — the
...
export class OLTurtle {
   ...
   * (`spec/execution-model.md:900`) — two turtle values are the same turtle exactly when their ids
