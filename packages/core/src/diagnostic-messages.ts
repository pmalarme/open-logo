 ...
 *
 * **This is prose, not identity, and nothing here changes that.** `spec/error-model.md:255-260`
 * makes diagnostic identity `code` plus `params` and calls prose presentation, and `:262-264`
