 ...
 * `spec/interaction-events.md:289-290`), and when a key's browser default is suppressed.
 */
...
test("#952: both a canvas click and the accessible activation control deliver a click", () => {
  ...
  assert.equal(
    controller.clicks,
    2,
    'spec/interaction-events.md:289-290 — "or activated by an equivalent accessible action"',
  );
});
