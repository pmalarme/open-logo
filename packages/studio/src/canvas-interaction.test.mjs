 ...
 * `spec/interaction-events.md:293-294`), and when a key's browser default is suppressed.
 */
...
test("#952: both a canvas click and the accessible activation control deliver a click", () => {
  ...
  assert.equal(
    controller.clicks,
    2,
    'spec/interaction-events.md:293-294 — "or activated by an equivalent accessible action"',
  );
});
