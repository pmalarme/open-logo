...
test("the question is put to the learner over the picture the program has already drawn", () => {
  ...
  // draws the square and then asks. `spec/interaction-events.md:169-171` permits exactly this
...
test("dismissing the question publishes the run's own cancellation, not an invented one", () => {
  ...
  // diagnostic the learner sees is the runtime's — `spec/interaction-events.md:171-172`'s other
 ...
 * `spec/interaction-events.md:169-172` ("until the read finishes").
 */
