 ...
 * `spec/interaction-events.md:168-171` makes `input` the only blocking read in v0.1, and
...
export type BlockingReadOutcome =
  ...
  | {
       ...
       * (`spec/interaction-events.md:170-171`), so they need not be distinguished here.
       */
 ...
 * `spec/interaction-events.md:170-171` describes.
 */
