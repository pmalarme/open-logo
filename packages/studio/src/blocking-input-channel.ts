 ...
 * `spec/interaction-events.md#trace-stream-integration` makes `input` the only blocking read in v0.1, and
...
export type BlockingReadOutcome =
  ...
  | {
       ...
       * (`spec/interaction-events.md#trace-stream-integration`), so they need not be distinguished here.
       */
 ...
 * `spec/interaction-events.md#trace-stream-integration` describes.
 */
