 ...
 * `spec/interaction-events.md:169-172` makes `input` the only blocking read in v0.1, and
...
export type BlockingReadOutcome =
  ...
  | {
       ...
       * (`spec/interaction-events.md:171-172`), so they need not be distinguished here.
       */
 ...
 * `spec/interaction-events.md:171-172` describes.
 */
