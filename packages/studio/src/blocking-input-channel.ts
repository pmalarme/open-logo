 ...
 * `spec/interaction-events.md:130-133` makes `input` the only blocking read in v0.1, and
...
export type BlockingReadOutcome =
  ...
  | {
       ...
       * (`spec/interaction-events.md:132-133`), so they need not be distinguished here.
       */
 ...
 * `spec/interaction-events.md:132-133` describes.
 */
