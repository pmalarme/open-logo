 ...
 * `spec/interaction-events.md:165-168` makes `input` the only blocking read in v0.1, and
...
export type BlockingReadOutcome =
  ...
  | {
       ...
       * (`spec/interaction-events.md:167-168`), so they need not be distinguished here.
       */
 ...
 * `spec/interaction-events.md:167-168` describes.
 */
