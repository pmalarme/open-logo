 ...
 * response returns "the token classes in this document" (`:280-282`), so this adapter has no
 * licence to classify differently from a batch `highlight()` given the same source and profile set.
 * (`spec/tooling.md:296-297`'s explicit batch-parity MUST is about *diagnostics*, not tokens — the
