 ...
 * `spec/interaction-events.md:267-271` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:268-270 lists are reachable by their spelled word", () => {
