 ...
 * `spec/interaction-events.md:269-273` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:270-272 lists are reachable by their spelled word", () => {
