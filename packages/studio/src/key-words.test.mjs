 ...
 * `spec/interaction-events.md:281-285` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:282-284 lists are reachable by their spelled word", () => {
