 ...
 * `spec/interaction-events.md#on_key-key-word-block` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md#on_key-key-word-block lists are reachable by their spelled word", () => {
