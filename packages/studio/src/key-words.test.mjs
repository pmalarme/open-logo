 ...
 * `spec/interaction-events.md:282-286` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:283-285 lists are reachable by their spelled word", () => {
