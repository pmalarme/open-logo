 ...
 * `spec/interaction-events.md:243-247` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:244-246 lists are reachable by their spelled word", () => {
