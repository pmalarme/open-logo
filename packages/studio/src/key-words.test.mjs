 ...
 * `spec/interaction-events.md:278-282` asks for ("Implementations SHOULD document their supported
...
test("#952: the named keys spec/interaction-events.md:279-281 lists are reachable by their spelled word", () => {
