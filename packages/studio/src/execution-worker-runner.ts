 ...
 *
 * This is where `spec/interaction-events.md:160-163` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md:160-162` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `:160-163` blocks handlers only "until the
