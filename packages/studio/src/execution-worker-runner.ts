 ...
 *
 * This is where `spec/interaction-events.md#trace-stream-integration` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md#trace-stream-integration` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `spec/interaction-events.md#trace-stream-integration` blocks handlers only "until the
