 ...
 *
 * This is where `spec/interaction-events.md:168-171` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md:168-170` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `:168-171` blocks handlers only "until the
