 ...
 *
 * This is where `spec/interaction-events.md:165-168` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md:165-167` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `:165-168` blocks handlers only "until the
