 ...
 *
 * This is where `spec/interaction-events.md:169-172` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md:169-171` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `:169-172` blocks handlers only "until the
