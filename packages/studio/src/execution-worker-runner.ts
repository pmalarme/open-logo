 ...
 *
 * This is where `spec/interaction-events.md:156-159` is finally honoured without reconciliation:
 ...
 *
 * `spec/interaction-events.md:156-158` explicitly permits this ("the implementation **MAY** continue
 ...
 * read and could always park. #976 deletes that refusal — `:156-159` blocks handlers only "until the
