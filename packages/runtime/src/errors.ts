 ...
 * (`spec/execution-model.md:660-661` — Core `for ... in` is list-only), `ol-range` for a
 * `for ... from ... to ... by 0` step (`spec/execution-model.md:659-660`), a destructuring
 * pattern/element length mismatch (`spec/execution-model.md:723-724`), and `ol-duplicate-binder`
 ...
 * (`spec/execution-model.md:771-773`).
 */
 ...
 * `spec/data-structures.md:73-93`, `spec/execution-model.md:710-745`) whose target is not a list,
 ...
 * (`spec/execution-model.md:652-654` fixes the TYPE-before-RANGE order for `repeat`, one of the
 ...
 * `spec/execution-model.md:780` — "OpenLogo never exposes NaN or Infinity as learner-facing
 ...
 * between — but `spec/execution-model.md:780` ("OpenLogo never exposes NaN or Infinity as
 ...
 * (`spec/execution-model.md:659-660` — a step of `0` never reaches `end`, so it is rejected
 ...
 * (`spec/execution-model.md:723-724` — "a short or long pattern mismatch raises `ol-range`"):
 ...
 * not a list (`spec/execution-model.md:681-685` — every comprehension form ranges over a list).
 ...
 * infinite stroke width for every subsequent `draw-segment` (`spec/execution-model.md:780` —
 ...
 * positive and finite (`spec/interaction-events.md:335` — "one positive number"; the default tempo
...
export const runtimeDiag = {
   ...
   * is not scoped to any one caller — `spec/execution-model.md:652-654` fixes the TYPE-before-RANGE
  ...
  /**
   * `ol-range`: a count is a whole number but negative (`spec/execution-model.md:652-654` fixes the
   ...
   * overflow, e.g. `forward power 10 1000` — `spec/execution-model.md:780`). Only reached once
   ...
   * overflow, e.g. `right power 10 1000` — `spec/execution-model.md:780`, same rationale as
   ...
   * overflow, e.g. `set_heading power 10 1000` — `spec/execution-model.md:780`, same rationale as
   ...
   * turns this into `NaN` — the coordinate is set directly — but `spec/execution-model.md:780`
   ...
   * (`spec/execution-model.md:660-661`); dict iteration is a later, profile-specific form.
   */
  forInNotList(
    source_span: SourceSpan,
   ...
   * (`spec/execution-model.md:681-685` — every comprehension form ranges over a list, same
   ...
   * (`spec/execution-model.md:659-660`), unlike a step merely pointing away from `end` (which
   ...
   * (`spec/execution-model.md:723-724`). `params.value` is the element's actual length (`0` for a
   * non-list element).
   */
   ...
   * (`spec/execution-model.md:618-624`, `spec/error-model.md:114`). Raised at the CALL site, not
   ...
   * (`spec/interaction-events.md:335`: "one positive number"). Only reached once
