 ...
 * (`spec/execution-model.md:403-404` — Core `for ... in` is list-only), `ol-range` for a
 * `for ... from ... to ... by 0` step (`spec/execution-model.md:402-403`), a destructuring
 * pattern/element length mismatch (`spec/execution-model.md:477-478`), and `ol-duplicate-binder`
 ...
 * (`spec/execution-model.md:525-527`).
 */
 ...
 * `spec/data-structures.md:73-93`, `spec/execution-model.md:464-499`) whose target is not a list,
 ...
 * (`spec/execution-model.md:395-397` fixes the TYPE-before-RANGE order for `repeat`, one of the
 ...
 * `spec/execution-model.md:534` — "OpenLogo never exposes NaN or Infinity as learner-facing
 ...
 * between — but `spec/execution-model.md:534` ("OpenLogo never exposes NaN or Infinity as
 ...
 * (`spec/execution-model.md:402-403` — a step of `0` never reaches `end`, so it is rejected
 ...
 * (`spec/execution-model.md:477-478` — "a short or long pattern mismatch raises `ol-range`"):
 ...
 * not a list (`spec/execution-model.md:435-439` — every comprehension form ranges over a list).
 ...
 * infinite stroke width for every subsequent `draw-segment` (`spec/execution-model.md:534` —
...
export const runtimeDiag = {
   ...
   * is not scoped to any one caller — `spec/execution-model.md:395-397` fixes the TYPE-before-RANGE
  ...
  /**
   * `ol-range`: a count is a whole number but negative (`spec/execution-model.md:395-397` fixes the
   ...
   * overflow, e.g. `forward power 10 1000` — `spec/execution-model.md:534`). Only reached once
   ...
   * overflow, e.g. `right power 10 1000` — `spec/execution-model.md:534`, same rationale as
   ...
   * overflow, e.g. `set_heading power 10 1000` — `spec/execution-model.md:534`, same rationale as
   ...
   * turns this into `NaN` — the coordinate is set directly — but `spec/execution-model.md:534`
   ...
   * (`spec/execution-model.md:403-404`); dict iteration is a later, profile-specific form.
   */
  forInNotList(
    source_span: SourceSpan,
   ...
   * (`spec/execution-model.md:435-439` — every comprehension form ranges over a list, same
   ...
   * (`spec/execution-model.md:402-403`), unlike a step merely pointing away from `end` (which
   ...
   * (`spec/execution-model.md:477-478`). `params.value` is the element's actual length (`0` for a
   * non-list element).
   */
   ...
   * (`spec/execution-model.md:374-380`, `spec/error-model.md:114`). Raised at the CALL site, not
