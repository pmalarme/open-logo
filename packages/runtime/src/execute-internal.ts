...
function homeTurtleForClearScreen(
  ...
  // point-in-time snapshot at the moment of emission (`spec/execution-model.md:751`) and each
 ...
 * progression (`spec/execution-model.md:740-751`, "for the SAME target") could never observe two
 ...
 * `spec/execution-model.md:740-751`'s "observable ordering ... for a given target-source-span
 * value" requirement.
 */
 ...
 * (`spec/execution-model.md:874-912`).
 *
 ...
 *
 * Both loops' binders are fresh **body-local** bindings (`spec/execution-model.md:340,969`): each
 ...
 * profile's `hint` progression (`spec/execution-model.md:740-751`) starts over — every target
