 ...
 * requires a host to track itself (`spec/execution-model.md:1006-1018` — progression state "is a
...
export interface TutorContext {
   ...
   * `spec/execution-model.md:992`'s `target-source-span` rule).
   */
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:1006-1018`).
