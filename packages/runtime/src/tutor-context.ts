 ...
 * requires a host to track itself (`spec/execution-model.md:1005-1017` — progression state "is a
...
export interface TutorContext {
   ...
   * `spec/execution-model.md:991`'s `target-source-span` rule).
   */
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:1005-1017`).
