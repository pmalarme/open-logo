 ...
 * requires a host to track itself (`spec/execution-model.md:657-669` — progression state "is a
...
export interface TutorContext {
   ...
   * `spec/execution-model.md:643`'s `target-source-span` rule).
   */
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:657-669`).
