...
export interface TutorCommandMetadata {
   ...
   * `spec/educational-model.md#explain`'s "Name the command or special form"), or a learner-defined
   * procedure.
   */
 ...
 * requires a host to track itself (`spec/execution-model.md#tutor-output-educational-profile` — progression state "is a
...
export interface TutorContext {
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md#trace-and-event-registry`).
