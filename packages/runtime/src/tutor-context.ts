 ...
 * requires a host to track itself (`spec/execution-model.md:903-915` — progression state "is a
...
export interface TutorContext {
   ...
   * `spec/execution-model.md:889`'s `target-source-span` rule).
   */
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:903-915`).
