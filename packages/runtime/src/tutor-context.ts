 ...
 * is a call the tutor can identify (`spec/educational-model.md:454`'s "known command
 ...
 * (`spec/educational-model.md:454`: "the parsed program, source spans, trace events,
