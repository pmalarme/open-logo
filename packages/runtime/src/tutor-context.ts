 ...
 * requires a host to track itself (`spec/execution-model.md:1000-1012` — progression state "is a
...
export interface TutorContext {
   ...
   * `spec/execution-model.md:986`'s `target-source-span` rule).
   */
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:1000-1012`).
