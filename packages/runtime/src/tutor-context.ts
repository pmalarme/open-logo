 ...
 * requires a host to track itself (`spec/execution-model.md:773-785` — progression state "is a
...
export interface TutorContext {
   ...
   * nudge → concept → partial → last-resort progression (`spec/execution-model.md:773-785`).
