 ...
 * `spec/execution-model.md:740-751` calls for: a mutable map (like `instructionCount`/`addressing`,
 ...
 * examples `:794-840`): binder-duplicate check first ({@link comprehensionDuplicateBinder}), then
