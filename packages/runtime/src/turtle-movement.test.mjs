...
// spec/execution-model.md:912-913's movement math, spec/rendering.md's "Line segments" section).
...
test("execute raises ol-range for a forward distance that overflows to Infinity, instead of emitting a NaN-corrupted move event", () => {
  ...
  // guard prevents by halting instead of emitting a corrupted event (spec/execution-model.md:884:
