...
// (issue #665, `spec/turtles-and-sprites.md:13`, `spec/execution-model.md:25,906`): identity
...
// --- identity equality (spec/execution-model.md:906 — turtle row is "Same turtle identity") ----
