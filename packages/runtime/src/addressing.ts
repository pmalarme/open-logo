 ...
 * closed (`spec/execution-model.md:952-957`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:966`), exists for — the same reading under which the Interaction
 * registration *forms* emit `primitive` (`spec/interaction-events.md:151-152,166-168`). So the
 ...
 * `spec/execution-model.md:908-909`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:915-924`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:901`), and an addressing event describes a *set*, not one turtle — the
