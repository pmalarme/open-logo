 ...
 * closed (`spec/execution-model.md:1056-1061`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:1070`), exists for — the same reading under which the Interaction
 * registration *forms* emit `primitive` (`spec/interaction-events.md:166-167,181-183`). So the
 ...
 * `spec/execution-model.md:1012-1013`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:1019-1028`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:1005`), and an addressing event describes a *set*, not one turtle — the
