 ...
 * closed (`spec/execution-model.md:706-711`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:720`), exists for — the same reading under which the Interaction
 * registration *forms* emit `primitive` (`spec/interaction-events.md:116-117,131-133`). So the
 ...
 * `spec/execution-model.md:662-663`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:669-678`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:655`), and an addressing event describes a *set*, not one turtle — the
