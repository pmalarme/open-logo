 ...
 * closed (`spec/execution-model.md:788-793`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:802`), exists for — the same reading under which the Interaction
 ...
 * `spec/execution-model.md:744-745`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:751-760`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:737`), and an addressing event describes a *set*, not one turtle — the
