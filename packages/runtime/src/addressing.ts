 ...
 * closed (`spec/execution-model.md:1049-1054`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:1063`), exists for — the same reading under which the Interaction
 * registration *forms* emit `primitive` (`spec/interaction-events.md:162-163,177-179`). So the
 ...
 * `spec/execution-model.md:1005-1006`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:1012-1021`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:998`), and an addressing event describes a *set*, not one turtle — the
