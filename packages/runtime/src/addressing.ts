 ...
 * closed (`spec/execution-model.md:840-845`: `kind` is "One registered event kind"), the spec is
 ...
 * event" (`spec/execution-model.md:854`), exists for — the same reading under which the Interaction
 ...
 * `spec/execution-model.md:796-797`). `name` is the addressing primitive whose effect this is; the
 ...
 * (`spec/execution-model.md:803-812`): a later change of the addressed set must not retroactively
 ...
 * (`spec/execution-model.md:789`), and an addressing event describes a *set*, not one turtle — the
