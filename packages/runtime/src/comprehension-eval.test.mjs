...
// spec/execution-model.md:386-496, worked examples :874-910). Conformance fixtures under
...
test("reduce over an empty list returns `from` unchanged (spec/execution-model.md:408)", () => {
  const result = execute(
...
test("a destructuring item binder destructures each element positionally (spec/execution-model.md:474-476)", () => {
  const result = execute(
