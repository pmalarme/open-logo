 ...
 * so the guardrail in `spec/execution-model.md:646-656` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:657-669`: absent -> `"nudge"`; each known
