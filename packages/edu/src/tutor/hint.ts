 ...
 * so the guardrail in `spec/execution-model.md:629-630,764-772` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:773-785`: absent -> `"nudge"`; each known
