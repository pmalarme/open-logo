...
/** The nudge -> concept -> partial -> last-resort order (`spec/educational-model.md:497-502`). */
 ...
 * (`spec/educational-model.md:499`'s "point attention to the relevant place").
 */
 ...
 * verbatim from `spec/educational-model.md:499-502`.
 */
