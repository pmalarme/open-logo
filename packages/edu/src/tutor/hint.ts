 ...
 * so the guardrail in `spec/execution-model.md:629-630,782-790` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:791-803`: absent -> `"nudge"`; each known
