 ...
 * so the guardrail in `spec/execution-model.md:994-1004` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:1005-1017`: absent -> `"nudge"`; each known
