 ...
 * so the guardrail in `spec/execution-model.md:933-943` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:944-956`: absent -> `"nudge"`; each known
