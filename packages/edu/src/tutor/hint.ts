 ...
 * so the guardrail in `spec/execution-model.md#turtle-and-canvas-state, spec/execution-model.md#execution-safety` holds unconditionally: no stage, not even
...
/** The nudge -> concept -> partial -> last-resort order (`spec/educational-model.md#hint`). */
 ...
 * `target-source-span`, per `spec/execution-model.md#trace-and-event-registry`: absent -> `"nudge"`; each known
 ...
 * (`spec/educational-model.md#hint`'s "point attention to the relevant place").
 */
 ...
 * verbatim from `spec/educational-model.md#hint`.
 */
