 ...
 * so the guardrail in `spec/execution-model.md:629-630,731-738` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:739-751`: absent -> `"nudge"`; each known
