 ...
 * so the guardrail in `spec/execution-model.md:995-1005` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:1006-1018`: absent -> `"nudge"`; each known
