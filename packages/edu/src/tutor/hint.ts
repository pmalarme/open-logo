 ...
 * so the guardrail in `spec/execution-model.md:970-980` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:981-993`: absent -> `"nudge"`; each known
