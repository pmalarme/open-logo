 ...
 * so the guardrail in `spec/execution-model.md:989-999` holds unconditionally: no stage, not even
 ...
 * `target-source-span`, per `spec/execution-model.md:1000-1012`: absent -> `"nudge"`; each known
