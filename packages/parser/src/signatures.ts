 ...
 *
 * `when` (#682/I3), `every` (#683/I4), and `on_key` (#684/I5) are listed today: each is the head its
 * slice delivers end to end. `on_click` joins this table in its own slice (#685) as it becomes
