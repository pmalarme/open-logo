 ...
 * section). `set_tempo` takes one number (the beats-per-minute, `spec/interaction-events.md:343-356`)
 * and `beep` takes none (`spec/interaction-events.md:393-408`) — the two primitives slice S1 (#689)
