...
//     and a reporter-call expression — per spec/grammar.md#ebnf-notation (assignment ::= colon-place "="
...
// ── The CRITICAL form/place asymmetry (spec/grammar.md#ebnf-notation) ────────────────────────────────
