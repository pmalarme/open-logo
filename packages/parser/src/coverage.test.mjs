...
test("reports comprehension syntax errors", () => {
  ...
  // branch. Since `spec/error-model.md#normative-code-registry` made the delimiter class agnostic, that branch
...
// Per spec/grammar.md#ebnf-notation, spec/grammar.md#collections-records-and-comprehensions: `for … in`'s binder may also be a destructuring
...
test("reports malformed destructuring for-in binders", () => {
  ...
  // (`spec/error-model.md#normative-code-registry`, issue #947).
