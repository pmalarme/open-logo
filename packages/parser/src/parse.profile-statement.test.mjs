...
// (`spec/grammar.md:410`, `ol-reserved-word`), and that is exactly why the shaping matters: the
...
// A Core-only program may not DECLARE these words — `spec/grammar.md:410` makes profile words
