...
test('reports a parse error for make "name" with no value expression', () => {
  // `make-assignment ::= "make" word-literal expression` (spec/grammar.md#ebnf-notation) requires a value
...
test("reports ol-bad-token for a make target that is not a word literal", () => {
  ...
  // wrong token (`spec/error-model.md#normative-code-registry`) — the `lexDiagnosticInGap` suppression must not
