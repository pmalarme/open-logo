...
//
// Those registries cover every spelling `spec/conformance.md#data, spec/conformance.md#heritage`'s Heritage inventory writes
...
test("the registries enumerate every code-formatted Heritage spelling the spec lists", () => {
  ...
  //
  // The bullets are the normative inventory (`spec/conformance.md#data, spec/conformance.md#heritage`, "It includes:"). Every
