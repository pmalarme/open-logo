 ...
 * `repeat 4 [ forward 100 right 90 ]` — `spec/grammar.md#blocks-and-bracket-roles` and , the specification's own
...
test("the spec's own instruction-block example is style-clean (issue #932)", () => {
  // `repeat 4 [ forward 100 right 90 ]` is `spec/grammar.md#blocks-and-bracket-roles` and .
