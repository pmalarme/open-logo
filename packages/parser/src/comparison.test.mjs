...
// spec/grammar.md#expressions-and-calls, each with its callee span; that comparison binds looser than
// additive/multiplicative but tighter than `and`/`or` (spec/grammar.md#expressions-and-calls); and that
// `=` assignment and `==` comparison stay distinct on the same variable (spec/grammar.md#ebnf-notation, spec/grammar.md#expressions-and-calls).
//
