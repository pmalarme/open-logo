...
// spec/grammar.md:182, each with its callee span; that comparison binds looser than
// additive/multiplicative but tighter than `and`/`or` (spec/grammar.md:179-182,187-188); and that
// `=` assignment and `==` comparison stay distinct on the same variable (spec/grammar.md:104,182).
//
