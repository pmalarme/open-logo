...
// `return`/`stop` statements that appear inside a procedure body, per spec/grammar.md#ebnf-notation
...
test("`return` requires a value expression — Core has no bare `return` (spec/grammar.md#ebnf-notation)", () => {
