 ...
 *   (`spec/data-structures.md#dictionary-writes-and-upserts, spec/data-structures.md#dictionary-operations`) — checked identically in either call form.
 *
 ...
 *   no new semantics" (`spec/conformance.md#data`), the behaviour issues #670/#733/#741/#787 pinned.
 ...
 * (`spec/data-structures.md#dictionary-writes-and-upserts, spec/data-structures.md#dictionary-operations`), never optional/variadic. Mirrors
...
export function arityRule(
  ...
  // spells — Heritage adds no semantics (`spec/conformance.md#data`). The reader already recorded
