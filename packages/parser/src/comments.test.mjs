...
// on main. Comments are whitespace per spec/grammar.md#lexical-form-and-encoding, spec/grammar.md#ebnf-notation: `#` and `//` start line
// comments; `/* */` is a non-nesting block comment; an unterminated block comment raises
// `ol-unclosed-comment` (spec/error-model.md#normative-code-registry). These tests cover cases not already
