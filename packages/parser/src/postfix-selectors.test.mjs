...
//   * every key-term form (spec/grammar.md#ebnf-notation): number, word literal, `:name` read, a bare
...
//
// Spans are asserted where they pin the selector's own `source_span` (spec/grammar.md#ebnf-notation).
...
test("an empty selector :nums[] reports the missing key, not a phantom unmatched bracket", () => {
  // `spec/error-model.md#normative-code-registry` MUST NOT: the `[` and `]` here are correctly matched in the
