...
test("a mismatched end label on a long block raises `ol-mismatched-end` at parse stage (per spec/grammar.md:283)", () => {
...
// Per spec/grammar.md:137-138, a `for … in` binder may be a bare `name` OR a destructuring
