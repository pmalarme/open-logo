...
// precedence over comparison/other operators matters (spec/grammar.md#ebnf-notation, spec/grammar.md#expressions-and-calls), and
...
// `[ key-term ]` selector form (`spec/grammar.md#ebnf-notation`, `selector ::= "[" key-term "]"`) is
