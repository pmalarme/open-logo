 ...
 * ruling #984 (`spec/interaction-events.md:169-174`), exactly as `on_key` and `on_click` always
 ...
 * exactly one handler — `"start"` occurs once per run (`spec/interaction-events.md:163-167`) — and
