 ...
 * ruling #984 (`spec/interaction-events.md:215-220`), exactly as `on_key` and `on_click` always
 ...
 * exactly one handler — `"start"` occurs once per run (`spec/interaction-events.md:209-213`) — and
