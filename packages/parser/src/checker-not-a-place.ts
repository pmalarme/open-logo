 ...
 * (`spec/error-model.md`, `spec/tooling.md#layer-2-semantic-checking`).
 *
 * `spec/tooling.md#layer-2-semantic-checking` mandates `count :nums = 3` → `ol-not-a-place`,
 ...
 *    base can be *any* primary per `spec/grammar.md#expressions-and-calls`, including a comprehension, `is`-predicate,
 ...
 * this is exactly {@link ExpressionNode} (`spec/grammar.md#places-selectors-and-keys`, the `AssignNode` doc comment
 ...
 * (`spec/tooling.md#layer-2-semantic-checking`). Prefers slicing `source` (exact for any shape); falls back to
