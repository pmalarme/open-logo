...
//      PAINT is profile-gated, but their DECLARATION is not: `spec/grammar.md:410` and
...
test("check: redefining an Interaction block-head under an active profile raises ol-reserved-word", () => {
  ...
  // `spec/grammar.md:410` and `spec/interaction-events.md:43-47` make them unconditional ("reserved
...
test("#841: redefining an Interaction block-head raises under Core-only too", () => {
  // `spec/interaction-events.md:43-47` and `spec/grammar.md:410` make these words built-in names
