...
test("message template matches spec/error-model.md#normative-code-registry exactly, with a suggestion", () => {
...
test("issue #136 / spec/tooling.md#layer-2-semantic-checking worked example: with turtle-rendering active, fowad suggests forward", () => {
