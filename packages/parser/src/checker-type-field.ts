 ...
 * call argument, and `spec/tooling.md:200-202` requires tools MUST NOT report speculative type
 ...
 * exactly the speculative inference `spec/tooling.md:198-202` forbids when a value is only known
 ...
 *
 * Scope is deliberately narrow (`spec/tooling.md:198` forbids speculative inference):
