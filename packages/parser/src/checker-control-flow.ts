 ...
 *   body. The spec (`spec/execution-model.md:772-773`, `spec/error-model.md:115`) says a
 ...
 *   expression (`spec/error-model.md:113`, `spec/execution-model.md:772`). Reproduces the spec's
 ...
 *   accumulator equal to its item binder (`spec/execution-model.md:792,1276`), or a repeated name in
