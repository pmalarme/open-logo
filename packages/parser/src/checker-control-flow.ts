 ...
 *   accumulator equal to its item binder (`spec/execution-model.md#comprehensions-map-filter-and-reduce, spec/execution-model.md#reduce`), or a repeated name in
 *   a destructuring pattern — `for [:x :x] in …` or a `map`/`filter`/`reduce [:x :x] in …`
 *   comprehension (issue #440) — (`spec/error-model.md#normative-code-registry`, `spec/tooling.md#layer-2-semantic-checking`).
 *
 ...
 * structured params (`spec/error-model.md#localization-boundary`), so `params.keyword` is always the canonical
 ...
 * unknown" (`spec/tooling.md#layer-2-semantic-checking`).
 */
...
/**
 * The span of just the control word of a `return`/`stop` — `spec/tooling.md#layer-2-semantic-checking` mandates pointing
