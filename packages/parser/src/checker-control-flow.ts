 ...
 *   body. The spec (`spec/execution-model.md:710-711`, `spec/error-model.md:115`) says a
 ...
 *   expression (`spec/error-model.md:113`, `spec/execution-model.md:710`). Reproduces the spec's
 ...
 *   accumulator equal to its item binder (`spec/execution-model.md:730,1214`), or a repeated name in
