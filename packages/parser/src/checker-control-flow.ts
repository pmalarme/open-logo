 ...
 *   body. The spec (`spec/execution-model.md:412-413`, `spec/error-model.md:115`) says a
 ...
 *   expression (`spec/error-model.md:113`, `spec/execution-model.md:412`). Reproduces the spec's
 ...
 *   accumulator equal to its item binder (`spec/execution-model.md:443,910`), or a repeated name in
