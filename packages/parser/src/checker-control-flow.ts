 ...
 *   (`spec/error-model.md:114`, `spec/tooling.md:190` — *point at the control word*).
 ...
 *   body. The spec (`spec/execution-model.md:771-772`, `spec/error-model.md:115`) says a
 ...
 *   expression (`spec/error-model.md:113`, `spec/execution-model.md:771`). Reproduces the spec's
 ...
 *   accumulator equal to its item binder (`spec/execution-model.md:791,1275`), or a repeated name in
 *   a destructuring pattern — `for [:x :x] in …` or a `map`/`filter`/`reduce [:x :x] in …`
 *   comprehension (issue #440) — (`spec/error-model.md:116`, `spec/tooling.md:192`).
 *
 ...
 * structured params (`spec/error-model.md:256-261`), so `params.keyword` is always the canonical
