 ...
 * the checker's did-you-mean machinery (`spec/error-model.md#normative-code-registry`,
 * `spec/tooling.md#layer-2-semantic-checking`). Callers normalize both operands with OpenLogo's case-insensitive
