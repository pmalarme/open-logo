...
// (issue #65), per spec/grammar.md:236,382. The existing corpus already proves these four words
...
// where a built-in name raises `ol-reserved-word` (spec/grammar.md:384) — and in the `for` binder
...
//
// The `define` row is the load-bearing one: spec/grammar.md:382 says these four are "structural by
