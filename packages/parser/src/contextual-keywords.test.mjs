...
// (issue #65), per spec/grammar.md#expressions-and-calls, spec/grammar.md#keywords-primitives-and-built-in-names. The existing corpus already proves these four words
...
// where a built-in name raises `ol-reserved-word` (spec/grammar.md#keywords-primitives-and-built-in-names) — and in the `for` binder
...
//
// The `define` row is the load-bearing one: spec/grammar.md#keywords-primitives-and-built-in-names says these four are "structural by
...
// maintainer ruling #833 accept ANY name (spec/grammar.md#keywords-primitives-and-built-in-names) — so they no longer distinguish these
