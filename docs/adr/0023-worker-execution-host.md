...
`spec/interaction-events.md#trace-stream-integration` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md#trace-stream-integration` explicitly permits the opposite ("the implementation **MAY**
