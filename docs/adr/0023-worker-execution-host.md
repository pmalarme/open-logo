...
`spec/interaction-events.md:130-133` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:130-132` explicitly permits the opposite ("the implementation **MAY**
