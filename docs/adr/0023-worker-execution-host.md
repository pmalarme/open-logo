...
`spec/interaction-events.md:108-111` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:108-110` explicitly permits the opposite ("the implementation **MAY**
