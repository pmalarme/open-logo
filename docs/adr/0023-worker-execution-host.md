...
`spec/interaction-events.md:168-171` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:168-170` explicitly permits the opposite ("the implementation **MAY**
