...
`spec/interaction-events.md:156-159` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:156-158` explicitly permits the opposite ("the implementation **MAY**
