...
`spec/interaction-events.md:169-172` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:169-171` explicitly permits the opposite ("the implementation **MAY**
