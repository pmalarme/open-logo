...
`spec/interaction-events.md:154-157` makes `input` the **only blocking read** in v0.1: no OpenLogo
...
`spec/interaction-events.md:154-156` explicitly permits the opposite ("the implementation **MAY**
